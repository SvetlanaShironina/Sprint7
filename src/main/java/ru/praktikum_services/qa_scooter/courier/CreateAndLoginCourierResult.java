...
public class CreateAndLoginCourierResult {
    ...
    public void createCourierExistingData(ValidatableResponse response) {
        response.assertThat()
    ...
    public void loginCourierNonExistingData(ValidatableResponse response) {
        response.assertThat()
